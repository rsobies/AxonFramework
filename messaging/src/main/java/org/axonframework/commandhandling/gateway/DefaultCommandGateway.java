...
public class DefaultCommandGateway implements CommandGateway {
     ...
     */
    private <C> CommandMessage asCommandMessage(Object command, MetaData metaData) {
        CommandMessage commandMessage = createCommandMessage(command, metaData);
        return enrichCommandMessage(commandMessage);
    }

    @SuppressWarnings("unchecked")
    private <C> CommandMessage createCommandMessage(Object command, MetaData metaData) {
    ...
    private <C> CommandMessage enrichCommandMessage(CommandMessage commandMessage) {
