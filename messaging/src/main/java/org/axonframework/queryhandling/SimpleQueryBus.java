...
public class SimpleQueryBus implements QueryBus {
    ...
    @Override
    public <Q, R> CompletableFuture<QueryResponseMessage> query(@Nonnull QueryMessage query) {
     ...
     * </p>
     */
    private static class CatchLastError<R> implements Function<ResultMessage, Mono<ResultMessage>> {
    ...
    @Override
    public <Q, R> Stream<QueryResponseMessage> scatterGather(@Nonnull QueryMessage query, long timeout,
    ...
    private <I, U> DefaultSubscriptionQueryResult<QueryResponseMessage, SubscriptionQueryUpdateMessage> getSubscriptionQueryResult(
    ...
    private <R> QueryResponseMessage asResponseMessage(Object result) {
        if (result instanceof QueryResponseMessage) {
            return (QueryResponseMessage) result;
        } else if (result instanceof ResultMessage) {
            ResultMessage resultMessage = (ResultMessage) result;
    ...
    private <Q> List<MessageHandler<? super QueryMessage, ? extends QueryResponseMessage>> getHandlersForMessage(
