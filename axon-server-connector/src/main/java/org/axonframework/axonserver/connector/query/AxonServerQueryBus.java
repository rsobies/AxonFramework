...
public class AxonServerQueryBus implements QueryBus, Distributed<QueryBus> {
    ...
    @Override
    public <Q, R> Publisher<QueryResponseMessage> streamingQuery(StreamingQueryMessage query) {
    ...
    @Override
    public <Q, R> CompletableFuture<QueryResponseMessage> query(@Nonnull QueryMessage queryMessage) {
    ...
    @Override
    public <Q, R> Stream<QueryResponseMessage> scatterGather(@Nonnull QueryMessage queryMessage,
                                                                long timeout,
    ...
    private static class QueryResponseSpliterator<Q, R> implements Spliterator<QueryResponseMessage> {
